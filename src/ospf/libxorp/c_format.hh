...
//
// c_format is a macro that creates a std::string from a c-style format
// std::string.  It takes the same arguments as printf, but %n is illegal and
// will cause abort to be called.
//
// Pseudo prototype:
//  std::string c_format(const char* format, ...);
//
...
template <class A, class B, class C, class D, class E, class F, class G,
          class H, class I, class J, class K, class L, class M, class N,
          class O>
inline int arg_count(A, B, C, D, E, F, G, H, I, J, K, L, M, N, O)
{
    return 15;
}
...
template <class A, class B, class C, class D, class E, class F, class G,
          class H, class I, class J, class K, class L, class M, class N,
          class O, class P>
inline int arg_count(A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P)
{
    return 16;
}
...
inline int arg_count(A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q)
{
    return 17;
}
