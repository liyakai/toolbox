...
typedef std::map<std::string, std::string>    SUBR_C; // XXX string* would be better...
...
public:
     ...
     */
    const Code::Target& target() const
    {
        return _target;
    }
