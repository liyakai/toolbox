/*
 * obj/x86_64-unknown-linux-gnu/xrl/interfaces/rib_xif.cc
...
{
    Xrl* x = ap_xrl_enable_rib.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "rib/0.1/enable_rib");
        ap_xrl_enable_rib.reset(x);
    }

    x->set_target(dst_xrl_target_name);


    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_enable_rib, cb));
}
...
{
    Xrl* x = ap_xrl_disable_rib.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "rib/0.1/disable_rib");
        ap_xrl_disable_rib.reset(x);
    }

    x->set_target(dst_xrl_target_name);


    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_disable_rib, cb));
}
...
{
    Xrl* x = ap_xrl_start_rib.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "rib/0.1/start_rib");
        ap_xrl_start_rib.reset(x);
    }

    x->set_target(dst_xrl_target_name);


    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_start_rib, cb));
}
...
{
    Xrl* x = ap_xrl_stop_rib.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "rib/0.1/stop_rib");
        ap_xrl_stop_rib.reset(x);
    }

    x->set_target(dst_xrl_target_name);


    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_stop_rib, cb));
}
...
{
    Xrl* x = ap_xrl_make_errors_fatal.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "rib/0.1/make_errors_fatal");
        ap_xrl_make_errors_fatal.reset(x);
    }

    x->set_target(dst_xrl_target_name);


    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_make_errors_fatal, cb));
}
...
{
    Xrl* x = ap_xrl_get_registered_protocols.get();
    ...
    if (!x) {
        ...
        ap_xrl_get_registered_protocols.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_get_registered_protocols, cb));
}
...
{
    Xrl* x = ap_xrl_add_igp_table4.get();
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_add_igp_table4, cb));
}
...
{
    Xrl* x = ap_xrl_delete_igp_table4.get();
    ...
    if (!x) {
        ...
        x->args().add("unicast", unicast);
        x->args().add("multicast", multicast);
        ap_xrl_delete_igp_table4.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_delete_igp_table4, cb));
}
...
{
    Xrl* x = ap_xrl_add_egp_table4.get();
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_add_egp_table4, cb));
}
...
{
    Xrl* x = ap_xrl_delete_egp_table4.get();
    ...
    if (!x) {
        ...
        x->args().add("unicast", unicast);
        x->args().add("multicast", multicast);
        ap_xrl_delete_egp_table4.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_delete_egp_table4, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_add_route4, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_replace_route4, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_delete_route4, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_add_interface_route4, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_replace_interface_route4, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_lookup_route_by_dest4, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_new_vif, cb));
}
...
{
    Xrl* x = ap_xrl_add_vif_addr4.get();
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_add_vif_addr4, cb));
}
...
{
    Xrl* x = ap_xrl_redist_enable4.get();
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_redist_enable4, cb));
}
...
{
    Xrl* x = ap_xrl_redist_disable4.get();
    ...
    if (!x) {
        ...
        x->args().add("multicast", multicast);
        x->args().add("cookie", cookie);
        ap_xrl_redist_disable4.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_redist_disable4, cb));
}
...
{
    Xrl* x = ap_xrl_redist_transaction_enable4.get();
    ...
    if (!x) {
        ...
        x->args().add("network_prefix", network_prefix);
        x->args().add("cookie", cookie);
        ap_xrl_redist_transaction_enable4.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_redist_transaction_enable4, cb));
}
...
{
    Xrl* x = ap_xrl_redist_transaction_disable4.get();
    ...
    if (!x) {
        ...
        x->args().add("multicast", multicast);
        x->args().add("cookie", cookie);
        ap_xrl_redist_transaction_disable4.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_redist_transaction_disable4, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_register_interest4, cb));
}
...
{
    Xrl* x = ap_xrl_deregister_interest4.get();
    ...
    if (!x) {
        ...
        ap_xrl_deregister_interest4.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_deregister_interest4, cb));
}
...
bool
XrlRibV0p1Client::send_remove_policy_redist_tags(
	const char*	dst_xrl_target_name,
	const string&	protocol,
	const RemovePolicyRedistTagsCB&	cb
)
{
    Xrl* x = ap_xrl_remove_policy_redist_tags.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "rib/0.1/remove_policy_redist_tags");
        x->args().add("protocol", protocol);
        ap_xrl_remove_policy_redist_tags.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_remove_policy_redist_tags, cb));
}


/* Unmarshall remove_policy_redist_tags */
void
XrlRibV0p1Client::unmarshall_remove_policy_redist_tags(
	const XrlError&	e,
	XrlArgs*	a,
...
{
    Xrl* x = ap_xrl_insert_policy_redist_tags.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "rib/0.1/insert_policy_redist_tags");
        x->args().add("protocol", protocol);
        x->args().add("policytags", policytags);
        ap_xrl_insert_policy_redist_tags.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_insert_policy_redist_tags, cb));
}
...
{
    Xrl* x = ap_xrl_reset_policy_redist_tags.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "rib/0.1/reset_policy_redist_tags");
        ap_xrl_reset_policy_redist_tags.reset(x);
    }

    x->set_target(dst_xrl_target_name);


    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_reset_policy_redist_tags, cb));
}
...
{
    Xrl* x = ap_xrl_get_protocol_admin_distances.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "rib/0.1/get_protocol_admin_distances");
        x->args().add("ipv4", ipv4);
        x->args().add("unicast", unicast);
        ap_xrl_get_protocol_admin_distances.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_get_protocol_admin_distances, cb));
}
...
{
    Xrl* x = ap_xrl_get_protocol_admin_distance.get();
    ...
    if (!x) {
        ...
        x->args().add("ipv4", ipv4);
        x->args().add("unicast", unicast);
        ap_xrl_get_protocol_admin_distance.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_get_protocol_admin_distance, cb));
}
...
{
    Xrl* x = ap_xrl_set_protocol_admin_distance.get();
    ...
    if (!x) {
        ...
        ap_xrl_set_protocol_admin_distance.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_set_protocol_admin_distance, cb));
}
...
{
    Xrl* x = ap_xrl_add_igp_table6.get();
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_add_igp_table6, cb));
}
...
{
    Xrl* x = ap_xrl_delete_igp_table6.get();
    ...
    if (!x) {
        ...
        x->args().add("unicast", unicast);
        x->args().add("multicast", multicast);
        ap_xrl_delete_igp_table6.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_delete_igp_table6, cb));
}
...
{
    Xrl* x = ap_xrl_add_egp_table6.get();
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_add_egp_table6, cb));
}
...
{
    Xrl* x = ap_xrl_delete_egp_table6.get();
    ...
    if (!x) {
        ...
        x->args().add("unicast", unicast);
        x->args().add("multicast", multicast);
        ap_xrl_delete_egp_table6.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_delete_egp_table6, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_add_route6, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_replace_route6, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_delete_route6, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_add_interface_route6, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_replace_interface_route6, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_lookup_route_by_dest6, cb));
}
...
{
    Xrl* x = ap_xrl_add_vif_addr6.get();
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_add_vif_addr6, cb));
}
...
{
    Xrl* x = ap_xrl_redist_enable6.get();
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_redist_enable6, cb));
}
...
{
    Xrl* x = ap_xrl_redist_disable6.get();
    ...
    if (!x) {
        ...
        x->args().add("multicast", multicast);
        x->args().add("cookie", cookie);
        ap_xrl_redist_disable6.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_redist_disable6, cb));
}
...
{
    Xrl* x = ap_xrl_redist_transaction_enable6.get();
    ...
    if (!x) {
        ...
        x->args().add("network_prefix", network_prefix);
        x->args().add("cookie", cookie);
        ap_xrl_redist_transaction_enable6.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_redist_transaction_enable6, cb));
}
...
{
    Xrl* x = ap_xrl_redist_transaction_disable6.get();
    ...
    if (!x) {
        ...
        x->args().add("multicast", multicast);
        x->args().add("cookie", cookie);
        ap_xrl_redist_transaction_disable6.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_redist_transaction_disable6, cb));
}
...
{
    Xrl* x = ap_xrl_register_interest6.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "rib/0.1/register_interest6");
        x->args().add("target", target);
        x->args().add("addr", addr);
        ap_xrl_register_interest6.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_register_interest6, cb));
}
...
{
    Xrl* x = ap_xrl_deregister_interest6.get();
    ...
    if (!x) {
        ...
        x->args().add("addr", addr);
        x->args().add("prefix_len", prefix_len);
        ap_xrl_deregister_interest6.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRibV0p1Client::unmarshall_deregister_interest6, cb));
}
