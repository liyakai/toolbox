/*
 * obj/x86_64-unknown-linux-gnu/xrl/interfaces/mld6igmp_xif.cc
...
)
{
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_enable_vif, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_start_vif, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_stop_vif, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_enable_all_vifs, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_start_all_vifs, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_stop_all_vifs, cb));
}
...
{
    Xrl* x = ap_xrl_enable_mld6igmp.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "mld6igmp/0.1/enable_mld6igmp");
        x->args().add("enable", enable);
        ap_xrl_enable_mld6igmp.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_enable_mld6igmp, cb));
}
...
{
    Xrl* x = ap_xrl_start_mld6igmp.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "mld6igmp/0.1/start_mld6igmp");
        ap_xrl_start_mld6igmp.reset(x);
    }

    x->set_target(dst_xrl_target_name);


    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_start_mld6igmp, cb));
}
...
{
    Xrl* x = ap_xrl_stop_mld6igmp.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "mld6igmp/0.1/stop_mld6igmp");
        ap_xrl_stop_mld6igmp.reset(x);
    }

    x->set_target(dst_xrl_target_name);


    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_stop_mld6igmp, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_enable_cli, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_start_cli, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_stop_cli, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_get_vif_proto_version, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_set_vif_proto_version, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_reset_vif_proto_version, cb));
}
...
{
    Xrl* x = ap_xrl_get_vif_ip_router_alert_option_check.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "mld6igmp/0.1/get_vif_ip_router_alert_option_check");
        x->args().add("vif_name", vif_name);
        ap_xrl_get_vif_ip_router_alert_option_check.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_get_vif_ip_router_alert_option_check, cb));
}
...
{
    Xrl* x = ap_xrl_set_vif_ip_router_alert_option_check.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "mld6igmp/0.1/set_vif_ip_router_alert_option_check");
        x->args().add("vif_name", vif_name);
        x->args().add("enable", enable);
        ap_xrl_set_vif_ip_router_alert_option_check.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_set_vif_ip_router_alert_option_check, cb));
}
...
{
    Xrl* x = ap_xrl_reset_vif_ip_router_alert_option_check.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "mld6igmp/0.1/reset_vif_ip_router_alert_option_check");
        x->args().add("vif_name", vif_name);
        ap_xrl_reset_vif_ip_router_alert_option_check.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_reset_vif_ip_router_alert_option_check, cb));
}
...
{
    Xrl* x = ap_xrl_get_vif_query_interval.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "mld6igmp/0.1/get_vif_query_interval");
        x->args().add("vif_name", vif_name);
        ap_xrl_get_vif_query_interval.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_get_vif_query_interval, cb));
}
...
{
    Xrl* x = ap_xrl_set_vif_query_interval.get();
    ...
    if (!x) {
        ...
        ap_xrl_set_vif_query_interval.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_set_vif_query_interval, cb));
}
...
{
    Xrl* x = ap_xrl_reset_vif_query_interval.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "mld6igmp/0.1/reset_vif_query_interval");
        x->args().add("vif_name", vif_name);
        ap_xrl_reset_vif_query_interval.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_reset_vif_query_interval, cb));
}
...
{
    Xrl* x = ap_xrl_get_vif_query_last_member_interval.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "mld6igmp/0.1/get_vif_query_last_member_interval");
        x->args().add("vif_name", vif_name);
        ap_xrl_get_vif_query_last_member_interval.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_get_vif_query_last_member_interval, cb));
}
...
{
    Xrl* x = ap_xrl_set_vif_query_last_member_interval.get();
    ...
    if (!x) {
        ...
        x->args().add("interval_sec", interval_sec);
        x->args().add("interval_usec", interval_usec);
        ap_xrl_set_vif_query_last_member_interval.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_set_vif_query_last_member_interval, cb));
}
...
{
    Xrl* x = ap_xrl_reset_vif_query_last_member_interval.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "mld6igmp/0.1/reset_vif_query_last_member_interval");
        x->args().add("vif_name", vif_name);
        ap_xrl_reset_vif_query_last_member_interval.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_reset_vif_query_last_member_interval, cb));
}
...
{
    Xrl* x = ap_xrl_get_vif_query_response_interval.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "mld6igmp/0.1/get_vif_query_response_interval");
        x->args().add("vif_name", vif_name);
        ap_xrl_get_vif_query_response_interval.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_get_vif_query_response_interval, cb));
}
...
{
    Xrl* x = ap_xrl_set_vif_query_response_interval.get();
    ...
    if (!x) {
        ...
        x->args().add("interval_sec", interval_sec);
        x->args().add("interval_usec", interval_usec);
        ap_xrl_set_vif_query_response_interval.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_set_vif_query_response_interval, cb));
}
...
{
    Xrl* x = ap_xrl_reset_vif_query_response_interval.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "mld6igmp/0.1/reset_vif_query_response_interval");
        x->args().add("vif_name", vif_name);
        ap_xrl_reset_vif_query_response_interval.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_reset_vif_query_response_interval, cb));
}
...
{
    Xrl* x = ap_xrl_get_vif_robust_count.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "mld6igmp/0.1/get_vif_robust_count");
        x->args().add("vif_name", vif_name);
        ap_xrl_get_vif_robust_count.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_get_vif_robust_count, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_set_vif_robust_count, cb));
}
...
{
    Xrl* x = ap_xrl_reset_vif_robust_count.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "mld6igmp/0.1/reset_vif_robust_count");
        x->args().add("vif_name", vif_name);
        ap_xrl_reset_vif_robust_count.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_reset_vif_robust_count, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_log_trace_all, cb));
}
...
{
    Xrl* x = ap_xrl_add_protocol4.get();
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_add_protocol4, cb));
}
...
{
    Xrl* x = ap_xrl_add_protocol6.get();
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_add_protocol6, cb));
}
...
{
    Xrl* x = ap_xrl_delete_protocol4.get();
    ...
    if (!x) {
        ...
        x->args().add("vif_name", vif_name);
        x->args().add("vif_index", vif_index);
        ap_xrl_delete_protocol4.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_delete_protocol4, cb));
}
...
{
    Xrl* x = ap_xrl_delete_protocol6.get();
    ...
    if (!x) {
        ...
        x->args().add("vif_name", vif_name);
        x->args().add("vif_index", vif_index);
        ap_xrl_delete_protocol6.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlMld6igmpV0p1Client::unmarshall_delete_protocol6, cb));
}
