/*
 * obj/x86_64-unknown-linux-gnu/xrl/interfaces/socket6_xif.cc
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket6V0p1Client::unmarshall_tcp_open, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket6V0p1Client::unmarshall_udp_open, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket6V0p1Client::unmarshall_tcp_open_and_bind, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket6V0p1Client::unmarshall_udp_open_and_bind, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket6V0p1Client::unmarshall_udp_open_bind_join, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket6V0p1Client::unmarshall_tcp_open_bind_connect, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket6V0p1Client::unmarshall_udp_open_bind_connect, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket6V0p1Client::unmarshall_bind, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket6V0p1Client::unmarshall_udp_join_group, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket6V0p1Client::unmarshall_udp_leave_group, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket6V0p1Client::unmarshall_close, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket6V0p1Client::unmarshall_tcp_listen, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket6V0p1Client::unmarshall_send, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket6V0p1Client::unmarshall_send_to, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket6V0p1Client::unmarshall_send_from_multicast_if, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket6V0p1Client::unmarshall_set_socket_option, cb));
}
