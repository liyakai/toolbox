/*
 * obj/x86_64-unknown-linux-gnu/xrl/interfaces/fea_rawpkt6_xif.cc
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRawPacket6V0p1Client::unmarshall_send, cb));
}
...
{
    Xrl* x = ap_xrl_register_receiver.get();
    ...
    if (!x) {
        ...
        ap_xrl_register_receiver.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRawPacket6V0p1Client::unmarshall_register_receiver, cb));
}
...
{
    Xrl* x = ap_xrl_unregister_receiver.get();
    ...
    if (!x) {
        ...
        x->args().add("vif_name", vif_name);
        x->args().add("ip_protocol", ip_protocol);
        ap_xrl_unregister_receiver.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRawPacket6V0p1Client::unmarshall_unregister_receiver, cb));
}
...
{
    Xrl* x = ap_xrl_join_multicast_group.get();
    ...
    if (!x) {
        ...
        ap_xrl_join_multicast_group.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRawPacket6V0p1Client::unmarshall_join_multicast_group, cb));
}
...
{
    Xrl* x = ap_xrl_leave_multicast_group.get();
    ...
    if (!x) {
        ...
        x->args().add("ip_protocol", ip_protocol);
        x->args().add("group_address", group_address);
        ap_xrl_leave_multicast_group.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlRawPacket6V0p1Client::unmarshall_leave_multicast_group, cb));
}
