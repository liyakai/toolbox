/*
 * obj/x86_64-unknown-linux-gnu/xrl/interfaces/redist6_xif.hh
...
private:
    static void unmarshall_add_route(
	const XrlError&	e,
	XrlArgs*	a,
	AddRouteCB		cb
    );

    static void unmarshall_delete_route(
	const XrlError&	e,
	XrlArgs*	a,
	DeleteRouteCB		cb
    );

    static void unmarshall_starting_route_dump(
	const XrlError&	e,
	XrlArgs*	a,
...
private:
    ...
    unique_ptr<Xrl> ap_xrl_add_route;
    unique_ptr<Xrl> ap_xrl_delete_route;
    unique_ptr<Xrl> ap_xrl_starting_route_dump;
    unique_ptr<Xrl> ap_xrl_finishing_route_dump;
};
