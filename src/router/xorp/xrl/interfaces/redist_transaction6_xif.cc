/*
 * obj/x86_64-unknown-linux-gnu/xrl/interfaces/redist_transaction6_xif.cc
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRedistTransaction6V0p1Client::unmarshall_start_transaction, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRedistTransaction6V0p1Client::unmarshall_commit_transaction, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRedistTransaction6V0p1Client::unmarshall_abort_transaction, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRedistTransaction6V0p1Client::unmarshall_add_route, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRedistTransaction6V0p1Client::unmarshall_delete_route, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRedistTransaction6V0p1Client::unmarshall_delete_all_routes, cb));
}
