/*
 * obj/x86_64-unknown-linux-gnu/xrl/interfaces/fea_fib_client_xif.hh
...
private:
    ...
    static void unmarshall_resolve_route4(
	const XrlError&	e,
	XrlArgs*	a,
	ResolveRoute4CB		cb
    );
    ...
    static void unmarshall_resolve_route6(
	const XrlError&	e,
	XrlArgs*	a,
	ResolveRoute6CB		cb
    );
...
private:
    ...
    unique_ptr<Xrl> ap_xrl_resolve_route4;
    unique_ptr<Xrl> ap_xrl_add_route6;
    unique_ptr<Xrl> ap_xrl_resolve_route6;
