...
)
{
    ...
    return _sender->send(*x, callback(&XrlVrrpV0p1Client::unmarshall_add_vrid, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlVrrpV0p1Client::unmarshall_delete_vrid, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlVrrpV0p1Client::unmarshall_set_priority, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlVrrpV0p1Client::unmarshall_set_interval, cb));
}
...
)
{
    ...
    if (!x) {
        ...
        x->args().add("vifname", vifname);
        x->args().add("vrid", vrid);
        x->args().add("preempt", preempt);
        ap_xrl_set_preempt.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlVrrpV0p1Client::unmarshall_set_preempt, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlVrrpV0p1Client::unmarshall_set_disable, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlVrrpV0p1Client::unmarshall_add_ip, cb));
}
...
bool
XrlVrrpV0p1Client::send_set_prefix(
	const char*	dst_xrl_target_name,
	const string&	ifname,
	const string&	vifname,
	const uint32_t&	vrid,
...
{
    Xrl* x = ap_xrl_set_prefix.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "vrrp/0.1/set_prefix");
        x->args().add("ifname", ifname);
        x->args().add("vifname", vifname);
        x->args().add("vrid", vrid);
        x->args().add("ip", ip);
        x->args().add("prefix_len", prefix_len);
        ap_xrl_set_prefix.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlVrrpV0p1Client::unmarshall_set_prefix, cb));
}


/* Unmarshall set_prefix */
void
XrlVrrpV0p1Client::unmarshall_set_prefix(
	const XrlError&	e,
	XrlArgs*	a,
	SetPrefixCB		cb
)
...
)
{
    ...
    return _sender->send(*x, callback(&XrlVrrpV0p1Client::unmarshall_delete_ip, cb));
}
...
{
    Xrl* x = ap_xrl_get_ifs.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "vrrp/0.1/get_ifs");
        ap_xrl_get_ifs.reset(x);
    }

    x->set_target(dst_xrl_target_name);


    return _sender->send(*x, callback(&XrlVrrpV0p1Client::unmarshall_get_ifs, cb));
}
...
{
    Xrl* x = ap_xrl_get_vifs.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "vrrp/0.1/get_vifs");
        x->args().add("ifname", ifname);
        ap_xrl_get_vifs.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlVrrpV0p1Client::unmarshall_get_vifs, cb));
}
...
{
    Xrl* x = ap_xrl_get_vrids.get();

    if (!x) {
        x = new Xrl(dst_xrl_target_name, "vrrp/0.1/get_vrids");
        x->args().add("ifname", ifname);
        x->args().add("vifname", vifname);
        ap_xrl_get_vrids.reset(x);
    }
    ...
    return _sender->send(*x, callback(&XrlVrrpV0p1Client::unmarshall_get_vrids, cb));
}
...
{
    Xrl* x = ap_xrl_get_vrid_info.get();
    ...
    return _sender->send(*x, callback(&XrlVrrpV0p1Client::unmarshall_get_vrid_info, cb));
}
