/*
 * obj/x86_64-unknown-linux-gnu/xrl/interfaces/redist4_xif.cc
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRedist4V0p1Client::unmarshall_add_route, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRedist4V0p1Client::unmarshall_delete_route, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRedist4V0p1Client::unmarshall_starting_route_dump, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlRedist4V0p1Client::unmarshall_finishing_route_dump, cb));
}
