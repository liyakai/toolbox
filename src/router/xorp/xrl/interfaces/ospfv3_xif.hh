/*
 * obj/x86_64-unknown-linux-gnu/xrl/interfaces/ospfv3_xif.hh
...
private:
    static void unmarshall_set_instance_id(
	const XrlError&	e,
	XrlArgs*	a,
	SetInstanceIdCB		cb
    );
    ...
    static void unmarshall_add_address_peer(
	const XrlError&	e,
	XrlArgs*	a,
	AddAddressPeerCB		cb
    );

    static void unmarshall_remove_address_peer(
	const XrlError&	e,
	XrlArgs*	a,
	RemoveAddressPeerCB		cb
    );

    static void unmarshall_set_address_state_peer(
	const XrlError&	e,
	XrlArgs*	a,
	SetAddressStatePeerCB		cb
    );

    static void unmarshall_activate_peer(
	const XrlError&	e,
	XrlArgs*	a,
	ActivatePeerCB		cb
    );

    static void unmarshall_update_peer(
	const XrlError&	e,
	XrlArgs*	a,
	UpdatePeerCB		cb
    );
...
private:
    ...
    unique_ptr<Xrl> ap_xrl_set_instance_id;
    ...
    unique_ptr<Xrl> ap_xrl_add_address_peer;
    unique_ptr<Xrl> ap_xrl_remove_address_peer;
    unique_ptr<Xrl> ap_xrl_set_address_state_peer;
    unique_ptr<Xrl> ap_xrl_activate_peer;
    unique_ptr<Xrl> ap_xrl_update_peer;
