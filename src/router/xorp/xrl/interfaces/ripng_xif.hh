/*
 * obj/x86_64-unknown-linux-gnu/xrl/interfaces/ripng_xif.hh
...
private:
    static void unmarshall_add_rip_address(
	const XrlError&	e,
	XrlArgs*	a,
	AddRipAddressCB		cb
    );

    static void unmarshall_remove_rip_address(
	const XrlError&	e,
	XrlArgs*	a,
	RemoveRipAddressCB		cb
    );

    static void unmarshall_set_rip_address_enabled(
	const XrlError&	e,
	XrlArgs*	a,
	SetRipAddressEnabledCB		cb
    );

    static void unmarshall_rip_address_enabled(
	const XrlError&	e,
	XrlArgs*	a,
	RipAddressEnabledCB		cb
    );

    static void unmarshall_set_cost(
	const XrlError&	e,
	XrlArgs*	a,
	SetCostCB		cb
    );

    static void unmarshall_cost(
	const XrlError&	e,
	XrlArgs*	a,
	CostCB		cb
    );

    static void unmarshall_set_horizon(
	const XrlError&	e,
	XrlArgs*	a,
	SetHorizonCB		cb
    );

    static void unmarshall_horizon(
	const XrlError&	e,
	XrlArgs*	a,
	HorizonCB		cb
    );
    ...
    static void unmarshall_passive(
	const XrlError&	e,
	XrlArgs*	a,
	PassiveCB		cb
    );

    static void unmarshall_set_accept_non_rip_requests(
	const XrlError&	e,
	XrlArgs*	a,
	SetAcceptNonRipRequestsCB		cb
    );

    static void unmarshall_accept_non_rip_requests(
	const XrlError&	e,
	XrlArgs*	a,
	AcceptNonRipRequestsCB		cb
    );

    static void unmarshall_set_accept_default_route(
	const XrlError&	e,
	XrlArgs*	a,
	SetAcceptDefaultRouteCB		cb
    );

    static void unmarshall_accept_default_route(
	const XrlError&	e,
	XrlArgs*	a,
	AcceptDefaultRouteCB		cb
    );

    static void unmarshall_set_advertise_default_route(
	const XrlError&	e,
	XrlArgs*	a,
	SetAdvertiseDefaultRouteCB		cb
    );

    static void unmarshall_advertise_default_route(
	const XrlError&	e,
	XrlArgs*	a,
	AdvertiseDefaultRouteCB		cb
    );

    static void unmarshall_set_route_timeout(
	const XrlError&	e,
	XrlArgs*	a,
	SetRouteTimeoutCB		cb
    );

    static void unmarshall_route_timeout(
	const XrlError&	e,
	XrlArgs*	a,
	RouteTimeoutCB		cb
    );

    static void unmarshall_set_deletion_delay(
	const XrlError&	e,
	XrlArgs*	a,
	SetDeletionDelayCB		cb
    );

    static void unmarshall_deletion_delay(
	const XrlError&	e,
	XrlArgs*	a,
	DeletionDelayCB		cb
    );

    static void unmarshall_set_request_interval(
	const XrlError&	e,
	XrlArgs*	a,
	SetRequestIntervalCB		cb
    );

    static void unmarshall_request_interval(
	const XrlError&	e,
	XrlArgs*	a,
	RequestIntervalCB		cb
    );

    static void unmarshall_set_update_interval(
	const XrlError&	e,
	XrlArgs*	a,
	SetUpdateIntervalCB		cb
    );

    static void unmarshall_update_interval(
	const XrlError&	e,
	XrlArgs*	a,
	UpdateIntervalCB		cb
    );

    static void unmarshall_set_update_jitter(
	const XrlError&	e,
	XrlArgs*	a,
	SetUpdateJitterCB		cb
    );

    static void unmarshall_update_jitter(
	const XrlError&	e,
	XrlArgs*	a,
	UpdateJitterCB		cb
    );

    static void unmarshall_set_triggered_update_delay(
	const XrlError&	e,
	XrlArgs*	a,
	SetTriggeredUpdateDelayCB		cb
    );

    static void unmarshall_triggered_update_delay(
	const XrlError&	e,
	XrlArgs*	a,
	TriggeredUpdateDelayCB		cb
    );

    static void unmarshall_set_triggered_update_jitter(
	const XrlError&	e,
	XrlArgs*	a,
	SetTriggeredUpdateJitterCB		cb
    );

    static void unmarshall_triggered_update_jitter(
	const XrlError&	e,
	XrlArgs*	a,
	TriggeredUpdateJitterCB		cb
    );

    static void unmarshall_set_interpacket_delay(
	const XrlError&	e,
	XrlArgs*	a,
	SetInterpacketDelayCB		cb
    );

    static void unmarshall_interpacket_delay(
	const XrlError&	e,
	XrlArgs*	a,
	InterpacketDelayCB		cb
    );

    static void unmarshall_rip_address_status(
	const XrlError&	e,
	XrlArgs*	a,
	RipAddressStatusCB		cb
    );

    static void unmarshall_get_all_addresses(
	const XrlError&	e,
	XrlArgs*	a,
	GetAllAddressesCB		cb
    );

    static void unmarshall_get_counters(
	const XrlError&	e,
	XrlArgs*	a,
	GetCountersCB		cb
    );

    static void unmarshall_get_peers(
	const XrlError&	e,
	XrlArgs*	a,
	GetPeersCB		cb
    );

    static void unmarshall_get_all_peers(
	const XrlError&	e,
	XrlArgs*	a,
	GetAllPeersCB		cb
    );

    static void unmarshall_get_peer_counters(
	const XrlError&	e,
	XrlArgs*	a,
...
private:
    ...
    unique_ptr<Xrl> ap_xrl_add_rip_address;
    unique_ptr<Xrl> ap_xrl_remove_rip_address;
    unique_ptr<Xrl> ap_xrl_set_rip_address_enabled;
    unique_ptr<Xrl> ap_xrl_rip_address_enabled;
    unique_ptr<Xrl> ap_xrl_set_cost;
    unique_ptr<Xrl> ap_xrl_cost;
    unique_ptr<Xrl> ap_xrl_set_horizon;
    unique_ptr<Xrl> ap_xrl_horizon;
    unique_ptr<Xrl> ap_xrl_set_passive;
    unique_ptr<Xrl> ap_xrl_passive;
    unique_ptr<Xrl> ap_xrl_set_accept_non_rip_requests;
    unique_ptr<Xrl> ap_xrl_accept_non_rip_requests;
    unique_ptr<Xrl> ap_xrl_set_accept_default_route;
    unique_ptr<Xrl> ap_xrl_accept_default_route;
    unique_ptr<Xrl> ap_xrl_set_advertise_default_route;
    unique_ptr<Xrl> ap_xrl_advertise_default_route;
    unique_ptr<Xrl> ap_xrl_set_route_timeout;
    unique_ptr<Xrl> ap_xrl_route_timeout;
    unique_ptr<Xrl> ap_xrl_set_deletion_delay;
    unique_ptr<Xrl> ap_xrl_deletion_delay;
    unique_ptr<Xrl> ap_xrl_set_request_interval;
    unique_ptr<Xrl> ap_xrl_request_interval;
    unique_ptr<Xrl> ap_xrl_set_update_interval;
    unique_ptr<Xrl> ap_xrl_update_interval;
    unique_ptr<Xrl> ap_xrl_set_update_jitter;
    unique_ptr<Xrl> ap_xrl_update_jitter;
    unique_ptr<Xrl> ap_xrl_set_triggered_update_delay;
    unique_ptr<Xrl> ap_xrl_triggered_update_delay;
    unique_ptr<Xrl> ap_xrl_set_triggered_update_jitter;
    unique_ptr<Xrl> ap_xrl_triggered_update_jitter;
    unique_ptr<Xrl> ap_xrl_set_interpacket_delay;
    unique_ptr<Xrl> ap_xrl_interpacket_delay;
    unique_ptr<Xrl> ap_xrl_rip_address_status;
    unique_ptr<Xrl> ap_xrl_get_all_addresses;
    unique_ptr<Xrl> ap_xrl_get_counters;
    unique_ptr<Xrl> ap_xrl_get_peers;
    unique_ptr<Xrl> ap_xrl_get_all_peers;
    unique_ptr<Xrl> ap_xrl_get_peer_counters;
