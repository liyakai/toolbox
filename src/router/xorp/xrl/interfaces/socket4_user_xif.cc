/*
 * obj/x86_64-unknown-linux-gnu/xrl/interfaces/socket4_user_xif.cc
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket4UserV0p1Client::unmarshall_recv_event, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket4UserV0p1Client::unmarshall_inbound_connect_event, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket4UserV0p1Client::unmarshall_outgoing_connect_event, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket4UserV0p1Client::unmarshall_error_event, cb));
}
...
)
{
    ...
    return _sender->send(*x, callback(&XrlSocket4UserV0p1Client::unmarshall_disconnect_event, cb));
}
